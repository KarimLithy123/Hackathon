...
class GATModel(torch.nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim, heads=4):
        ...
        self.embedding = torch.nn.Embedding(1, input_dim)  # Replace or remove as needed
    ...
    def forward(self, data):
        ...
        x = self.embedding(x) if x.dtype == torch.long else x  # In case node features are just indices
